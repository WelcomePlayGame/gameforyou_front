        ...
        <ul className="header_game_ul">
          ...
          {game?.articleSet && Object.keys(game.articleSet).length > 0 && (
            <li>
              ...
              >
                {words.NEWS}{" "}
                <span className="count_news_for_game">
                  ({game.articleSet.length})
                </span>
              </Link>
            </li>
          )}
        ...
        <div className="game_box_body">
            ...
            <div className="game_box_body_right">
              ...
              <div className="game_box_body_right_var">
                <span className="game_box_body_right_text">{`${
                  ...
                  game?.datatime
                    ? new Date(game.datatime).toLocaleDateString()
                    : "N/A"
                }`}</span>
                <span className="game_box_body_right_text">
                  {`${words.SITE_GAME} - `}
          ...
          <div className="game_box_body_des">
            ...
            <div className="game_box_comment">
              <span
                className="game_box_body_right_text write_comment"
                onClick={handleClose}
              >
