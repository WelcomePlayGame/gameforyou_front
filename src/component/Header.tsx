          ...
          <menu className="header_menu">
            <div className="header_menu_box ">
              <a href={`${process.env.PUBLIC_URL}`}>
                <img
                  src={`${process.env.PUBLIC_URL}/icons/logo_for_site.png`}
                  alt="GameForYou"
            ...
            <div className="header_menu_box header_group_icons">
                ...
                <div className="box_one">
                  <div className="header_setting_img">
                    <svg
                      ...
                      viewBox="0 0 64 64"
                    >
                      <g transform="matrix(1.22423,0,0,1.12028,-37.1546,15.1698)">
                      ...
                      <g transform="matrix(-1,0,0,1,64.0872,17)">
                        <path d="M35.963,10L52,10C53.104,10 54,10.896 54,12C54,13.104 53.104,14 52,14L35.963,14C34.859,14 33.963,13.104 33.963,12C33.963,10.896 34.859,10 35.963,10Z" />
                      </g>
                      <g transform="matrix(-1,0,0,1,64,24)">
                        <path d="M37.963,10L52,10C53.104,10 54,10.896 54,12C54,13.104 53.104,14 52,14L37.963,14C36.859,14 35.963,13.104 35.963,12C35.963,10.896 36.859,10 37.963,10Z" />
                      </g>
                      <g>
                        <path d="M47.999,34C51.712,34 55.273,35.475 57.899,38.101C60.525,40.727 62,44.288 62,48.002L62,60C62,61.105 61.104,62 60,62L40,62C32.269,62 26.001,55.732 26.001,48C26.001,40.268 32.269,34 40,34L47.999,34ZM44.039,46C45.143,46 46.039,46.896 46.039,48C46.039,49.104 45.143,50 44.039,50C42.935,50 42.039,49.104 42.039,48C42.039,46.896 42.935,46 44.039,46ZM37.962,46C39.066,46 39.963,46.896 39.963,48C39.963,49.104 39.066,50 37.962,50C36.858,50 35.962,49.104 35.962,48C35.962,46.896 36.858,46 37.962,46ZM50,46C51.104,46 52,46.896 52,48C52,49.104 51.104,50 50,50C48.896,50 48,49.104 48,48C48,46.896 48.896,46 50,46Z" />
                      </g>
                      <g>
                        <path d="M60,30L39.982,30C39.077,22.741 33.309,16.992 26.043,16.116C26.001,15.486 26.042,14.832 26.093,14.389C26.892,7.416 32.814,2 40,2L47.999,2C51.712,2 55.273,3.475 57.899,6.101C60.525,8.727 62,12.288 62,16.002L62,28C62,29.105 61.104,30 60,30ZM52.087,22C53.191,22 54.087,21.104 54.087,20C54.087,18.896 53.191,18 52.087,18L40.05,18C38.946,18 38.05,18.896 38.05,20C38.05,21.104 38.946,22 40.05,22L52.087,22ZM52,15C53.104,15 54,14.104 54,13C54,11.896 53.104,11 52,11L35.963,11C34.859,11 33.963,11.896 33.963,13C33.963,14.104 34.859,15 35.963,15L52,15Z" />
                      </g>
                    </svg>
                  </div>
                </div>
              ...
              <div className="header_other">
                <div className="box_one">
                  <div className="header_setting_img header_login">
                    <svg id="레이어_1" viewBox="0 0 40 40">
              ...
              <div className="header_other">
                <div className="box_one box_language">
                  <div className="header_setting_img header_language">
                    <span
                      className="span_language"
                      onClick={() => setLanguage(!isLanguage)}
                    >
                      <img
                        src={languages[currentLanguage]}
